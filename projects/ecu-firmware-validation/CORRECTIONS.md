...
- [ ] **MISRA:** current edition is MISRA C:2012 with Amendments 1/2/3, plus the 2023 consolidated re-issue. cppcheck has a MISRA add-on (`--addon=misra`) covering a subset; **clang-tidy does not check MISRA at all.** Say *"cppcheck's MISRA add-on covers many rules; full MISRA compliance requires a commercial tool."* Never "proves MISRA compliance".
...
ISO/SAE 21434 Clauses 11 and 15 · ISO 14229-1:2020 · ISO 15765-2:2016 · MISRA C:2012 (AMD1/2/3) · SEI CERT C · CycloneDX / SPDX · Regulation (EU) 2024/2847
