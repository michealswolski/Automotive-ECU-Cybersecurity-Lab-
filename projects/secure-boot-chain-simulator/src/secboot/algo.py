...
def _ec_spec(curve: ec.EllipticCurve, digest: hashes.HashAlgorithm, size: int) -> dict[str, Any]:
    ...
    def verify(pub: bytes, signature: bytes, data: bytes) -> None:
        ...
        public.verify(signature, data, ec.ECDSA(digest))
...
SPECS: dict[Algo, AlgoSpec] = {
    Algo.ECDSA_P256_SHA256: AlgoSpec(
        ...
        **_ec_spec(ec.SECP256R1(), hashes.SHA256(), 65),
    ),
    ...
    Algo.ECDSA_P384_SHA384: AlgoSpec(
        ...
        **_ec_spec(ec.SECP384R1(), hashes.SHA384(), 97),
    ),
}
